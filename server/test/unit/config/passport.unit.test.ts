...
>;
const mockFindById = userService.findById as jest.MockedFunction<
  typeof userService.findById
>;
const mockVerifyPassword =
  passwordService.verifyPassword as jest.MockedFunction<
    typeof passwordService.verifyPassword
  >;
...
describe("passport configuration", () => {
  ...
  describe("Edge cases and error handling", () => {
    ...
    it("should handle concurrent authentication attempts", async () => {
      ...
      expect(doneSpy1).toHaveBeenCalledWith(
        null,
        expect.objectContaining({
          email: "concurrent@example.com",
        })
      );
      expect(doneSpy2).toHaveBeenCalledWith(
        null,
        expect.objectContaining({
          email: "concurrent@example.com",
        })
